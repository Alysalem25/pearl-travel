        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <ul className="space-y-2">
              ...
              <li onClick={() => setActive("users")} className={Active === "users" ? "bg-gray-200 dark:bg-gray-700 rounded-lg" : ""}>
                <Link
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors duration-200 font-medium text-sm"
                >
                  <LogOut size={16} />
                  Logout
                </button>
