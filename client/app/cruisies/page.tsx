                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 py-4 ">
                            {cruisies.map((cruise, index) => (
                                <motion.div
                                    ...
                                    className="w-full text-black relative   bg-gray-100 p-12 rounded-2xl hover:shadow-lg hover:translate-y-3 cursor-pointer"
                                >
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <h1 className="text-4xl font-bold text-black">{cruise.nameER}</h1>
                                        <p className="text-black">{cruise.descriptionER}</p>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
